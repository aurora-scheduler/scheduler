...
import static io.github.aurora.scheduler.scheduling.ProbabilisticPriorityAssignerImpl.ASSIGNER_LAUNCH_FAILURES;
import static io.github.aurora.scheduler.scheduling.ProbabilisticPriorityAssignerImpl.LAUNCH_FAILED_MSG;

public class ProbabilisticPriorityAssignerImplTest extends EasyMockTest {
  ...
  private ProbabilisticPriorityAssignerImpl assigner;
  ...
  public void setUp() {
    ...
    assigner = new ProbabilisticPriorityAssignerImpl(
        stateManager,
        taskFactory,
        offerManager,
        updateAgentReserver,
